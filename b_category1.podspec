...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/sunyunfei/b_category1"
  ...
  s.source       = { :git => "https://github.com/sunyunfei/b_category1.git", :tag => s.version.to_s }
  ...
  s.source_files  = "b_category1/b_category1/**/*.{h,m,swift}"
